...
import { Panel, PanelPosition, VueFlow, isNode, useVueFlow, Position } from '@vue-flow/core'
 ...
 */
const { onPaneReady, onNodeDragStop, onConnect, addEdges, setTransform, toObject, findNode, addNodes, project, vueFlowRef, getSelectedElements } = useVueFlow();
